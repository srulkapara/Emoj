    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubbing.ShownRiddle')),
            ],
        ),
        migrations.CreateModel(
            name='Title',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referrer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubbing.User', null=True)),
            ],
        ),
        migrations.AddField(
            model_name='shownriddle',
            name='riddle_shown',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubbing.Riddle'),
        ),
        migrations.AddField(
            model_name='shownriddle',
            name='solver',
        ...
        migrations.AddField(
            model_name='riddle',
            name='reshared',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clubbing.Riddle', null=True),
        ),
        migrations.AddField(
            model_name='riddle',
            name='title',
